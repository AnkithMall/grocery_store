...
<table border="1" cellpadding="5" id="products" align="center">
    ...
    try{
    	...
    	String query = " select cartorder.pid,image,pname,description,q,price,q*price,odate from cartorder,product where cartorder.pid=product.pid and usrid="+request.getParameter("usrid") ;
